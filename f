    ...
    do -- Components
        Library.MakeWindow = function(self, Data)
            ...
            if ShowWelcomeIntro then
                ...
                AvatarHalo.Position = UDim2New(0.5, 0, 0.34, 0)
                ...
                Avatar.Position = UDim2New(0.5, 0, 0.34, 0)
                ...
                Title.Position = UDim2New(0.5, 0, 0.49, -2)
                Title.Size = UDim2New(0, 360, 0, 32)
                ...
                Subtitle.Position = UDim2New(0.5, 0, 0.555, 0)
                Subtitle.Size = UDim2New(0, 360, 0, 22)
                ...
                BarBack.Position = UDim2New(0.5, 0, 0.65, 0)
                BarBack.Size = UDim2New(0, 270, 0, 6)
                ...
                Status.Position = UDim2New(0.5, 0, 0.68, 0)
                Status.Size = UDim2New(0, 360, 0, 20)
                ...
                TweenService:Create(AvatarHalo, TweenInfo.new(0.65, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = UDim2New(0, 142, 0, 142), BackgroundTransparency = 0.84}):Play()
                TweenService:Create(Avatar, TweenInfo.new(0.6, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = UDim2New(0, 108, 0, 108), ImageTransparency = 0}):Play()
                TweenService:Create(Title, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {TextTransparency = 0, Position = UDim2New(0.5, 0, 0.49, -12)}):Play()
                TweenService:Create(Subtitle, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {TextTransparency = 0.35, Position = UDim2New(0.5, 0, 0.555, -8)}):Play()
                ...
                TweenService:Create(Status, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {TextTransparency = 0.45, Position = UDim2New(0.5, 0, 0.68, -8)}):Play()
                ...
                task.defer(function()
                    if Items["IntroScale"] and Items["IntroScale"].Instance then
                        TweenService:Create(
                            Items["IntroScale"].Instance,
