...
local Library do
    ...
    Library.GetConfig = function(self)
        ...
        local Success, Result = Library:SafeCall(function()
            for Index, Value in Library.Flags do 
                if ConfigIgnoreFlags[Index] then
                    continue
                end
    ...
    Library.LoadConfig = function(self, Config)
        ...
        if not ok or not Decoded then return false, "Failed to decode config JSON" end
            ...
            Callback = function()
                if ConfigSelected then
                    local Success, Error = pcall(function()
                        return Library:LoadConfig(readfile(Library.Folders.Configs .. "/" .. ConfigSelected..".json"))
                    end)
        ...
        task.defer(function()
            ...
            if AutoloadName then
                ...
                if isfile(FilePath) then
                    local Success, Error = pcall(function()
                        return Library:LoadConfig(readfile(FilePath))
                    end)
                    if Success then
                        pcall(function()
