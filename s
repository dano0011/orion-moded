...
local Library do
    ...
    Library.LoadConfig = function(self, Config)
        ...
        self._PendingConfigValues = self._PendingConfigValues or { }
    ...
    do -- Components
        ...
        Library.Sections.AddSlider = function(self, Data)
            ...
            local PendingConfigValues = Library._PendingConfigValues
            if PendingConfigValues and PendingConfigValues[Slider.Flag] ~= nil then
                Slider:Set(PendingConfigValues[Slider.Flag])
                PendingConfigValues[Slider.Flag] = nil
            elseif Slider.Default ~= nil then
