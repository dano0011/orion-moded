...
local Library do
    ...
    do
        local IntroFile = Library.Folders.Cache .. "/intro_seen.txt"

        if not isfile(IntroFile) then
            writefile(IntroFile, "1")
            ...
            Cover.Parent = IntroGui
            Cover.Size = UDim2FromScale(1, 1)
            Cover.BackgroundColor3 = FromRGB(8, 8, 12)
            ...
            Avatar.Position = UDim2New(0.5, 0, 0.38, -18)
            ...
            local Text = InstanceNew("TextLabel")
            Text.Parent = Cover
            Text.AnchorPoint = Vector2New(0.5, 0)
            Text.Position = UDim2New(0.5, 0, 0.5, -6)
            Text.Size = UDim2New(0, 360, 0, 40)
            Text.BackgroundTransparency = 1
            Text.FontFace = Library.Font
            Text.Text = "Welcome, " .. LocalPlayer.Name
            Text.TextColor3 = FromRGB(255, 255, 255)
            Text.TextSize = 24
            Text.TextTransparency = 1

            local Spinner = InstanceNew("ImageLabel")
            Spinner.Parent = Cover
            Spinner.AnchorPoint = Vector2New(0.5, 0.5)
            Spinner.Position = UDim2New(0.5, 0, 0.58, 0)
            Spinner.Size = UDim2New(0, 34, 0, 34)
            Spinner.BackgroundTransparency = 1
            Spinner.Image = "rbxassetid://4965945816"
            Spinner.ImageColor3 = FromRGB(255, 255, 255)
            Spinner.ImageTransparency = 1

            TweenService:Create(Cover, TweenInfo.new(0.45, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundTransparency = 0.12}):Play()
            TweenService:Create(Avatar, TweenInfo.new(0.6, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = UDim2New(0, 92, 0, 92), ImageTransparency = 0}):Play()
            TweenService:Create(Text, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {TextTransparency = 0, Position = UDim2New(0.5, 0, 0.5, -18)}):Play()
            TweenService:Create(Spinner, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {ImageTransparency = 0}):Play()
            ...
            TweenService:Create(Cover, TweenInfo.new(0.45, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {BackgroundTransparency = 1}):Play()
            TweenService:Create(Avatar, TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {Size = UDim2New(0, 70, 0, 70), ImageTransparency = 1}):Play()
            TweenService:Create(Text, TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {TextTransparency = 1}):Play()
            TweenService:Create(Spinner, TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {ImageTransparency = 1}):Play()
