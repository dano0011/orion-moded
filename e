...
local Library do
    ...
    local Instances = { } do
        ...
        Instances.Tooltip = function(self, Text)
            ...
            local TooltipInputConnectionName = "Tooltip_" .. HttpService:GenerateGUID(false)
            local Items = { }
            ...
            Library:Connect(Gui.MouseEnter, function()
                ...
                if InputChangedConnection then
                    Library:Disconnect(TooltipInputConnectionName)
                end

                InputChangedConnection = Library:Connect(UserInputService.InputChanged, function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch then
                        UpdateTooltipPosition()
                    end
                end, TooltipInputConnectionName)
            end)
        ...
        local SetRainbow = function(Bool)
            ...
            if IsRainbowToggled then 
                ...
                Library:Thread(function()
                    while Library and IsRainbowToggled and RainbowToken == Token do
    ...
    Library.CreateKeybind = function(self, Data)
        ...
        Items["KeyButton"]:Connect("MouseButton1Click", function()
            if Data.Premium or Keybind.Picking then return end
            ...
            local InputConnectionName = "KeybindPick_" .. HttpService:GenerateGUID(false)
            Library:Connect(UserInputService.InputBegan, function(Input)
                Library:Disconnect(InputConnectionName)
        ...
        Library.Sections.AddToggle = function(self, Data)
            ...
            local Items = { } do
                ...
                if Toggle.Warning then
                    ...
                    local WarnInputConnectionName = "WarningTooltip_" .. HttpService:GenerateGUID(false)
                    ...
                    local function HideWarnTooltip()
                        ...
                        if InputChangedConn then Library:Disconnect(WarnInputConnectionName) InputChangedConn = nil end
                    end

                    Library:Connect(WarnHitbox.MouseEnter, function()
                        if Library.HideTooltips or Library.ActiveBlockedSubTab then return end
                        UpdateWarnPos()
                        WarnTooltip:Tween(nil, {BackgroundTransparency = 0})
                        WarnText:Tween(nil, {TextTransparency = 0})
                        WarnStroke:Tween(nil, {Transparency = 0})
                        if InputChangedConn then Library:Disconnect(WarnInputConnectionName) end
                        InputChangedConn = Library:Connect(UserInputService.InputChanged, function(Input)
                            if Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch then
                                UpdateWarnPos()
                            end
                        end, WarnInputConnectionName)
                        if WarnAnimThread then task.cancel(WarnAnimThread) end
                        WarnAnimThread = task.spawn(function()
                            local toWhite = true
                            while Library and WarnTooltip.Instance.Parent do
                    ...
                    Library:Connect(WarnHitbox.MouseLeave, function()
                        HideWarnTooltip()
                    end)
                end
