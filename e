    ...
    do -- Components
        ...
        Library.Pages.AddSection = function(self, Data)
            ...
            local Items = { } do 
                ...
                if Section.Premium then
                    local PremiumHeight = Items["Content"].Instance.Position.Y.Offset + Items["Content"].Instance.AbsoluteSize.Y + 8
                    Items["IsPremium"].Instance.Size = UDim2New(1, -4, 0, PremiumHeight)
