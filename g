			...
			if callSafely(isfolder, ConfigurationFolder) then
				for _, file in ipairs(callSafely(listfiles, ConfigurationFolder) or {}) do
					...
					if name and name:sub(-#ConfigurationExtension) == ConfigurationExtension then
						table.insert(configs, name:sub(1, -#ConfigurationExtension - 1))
					end
				end
			end
			return configs
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			if ToggleSettings.CurrentValue == true then
				...
				Toggle.Switch.BackgroundColor3 = SelectedTheme.ToggleDisabled
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				if ToggleSettings.CurrentValue == true then
					...
					TweenService:Create(Toggle.Switch, TweenInfo.new(0.55, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {BackgroundColor3 = SelectedTheme.ToggleDisabled}):Play()
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					...
					TweenService:Create(Toggle.Switch, TweenInfo.new(0.55, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {BackgroundColor3 = SelectedTheme.ToggleEnabled}):Play()
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 0}):Play()		
				end
