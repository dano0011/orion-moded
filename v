    ...
    Library.CreateHomeTab = function(self, Window, DiscordLink)
        ...
        local Items = { } do
            Items["SessionInfo"] = Instances:Create("Frame", {
                ...
                Name = "\0",
                Position = UDim2New(0, 12, 0, 18),
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(1, -24, 0, 194),
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(26, 25, 31)
            ...
            Items["JoinDiscord"] = Instances:Create("TextButton", {
                ...
                Size = UDim2New(0, 132, 0, 36),
                BorderSizePixel = 0,
                TextSize = 14,
                BackgroundColor3 = FromRGB(118, 92, 255)
            })
            ...
            Items["JoinDiscord"]:Connect("MouseEnter", function()
                Items["JoinDiscord"]:Tween(nil, {
                    BackgroundColor3 = FromRGB(132, 108, 255),
                    Size = UDim2New(0, 136, 0, 38)
                })
            end)
            ...
            Items["JoinDiscord"]:Connect("InputBegan", function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                        ...
                        Items["JoinDiscord"]:Tween(nil, {Size = UDim2New(0, 126, 0, 34)})
                        task.wait(0.08)
                        Items["JoinDiscord"]:Tween(nil, {Size = UDim2New(0, 132, 0, 36)})
            ...
            Instances:Create("UIGradient", {
                ...
                Name = "\0",
                Rotation = 98,
                Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(186, 166, 255)), RGBSequenceKeypoint(1, FromRGB(118, 92, 255))}
            })
